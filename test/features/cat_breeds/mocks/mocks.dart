...
@GenerateNiceMocks([
  ...
  MockSpec<CatRepository>(),
  MockSpec<HttpClient>(),
  MockSpec<GetAllCatBreeds>(),
  MockSpec<SearchCatBreeds>(),
])
void main() {}

final mockCatBreedJson = {
...
final mockCatBreedModel = CatBreedModel.fromJson(mockCatBreedJson);

final mockCatBreedEntity = CatBreedMapper.toEntity(model: mockCatBreedModel);
